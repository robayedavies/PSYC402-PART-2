...
```{r pporteng, fig.cap = 'Plot of child grades, comparing English with Portuguese grades, shown separately for each school class', warning=FALSE, message=FALSE, echo=FALSE, fig.width=6, fig.height=6}
